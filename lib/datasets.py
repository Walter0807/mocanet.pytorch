from lib.data import _MixamoDatasetBase
import numpy as np
...
class MixamoDatasetForFull(_MixamoDatasetBase):
    ...
    def get_cluster_data(self, nr_motions=100):
        """
        ...
        motion_names = np.array([item.split('/')[0] for item in motion_items])
        ...
        for mot in motion_items:
            ...
            for char in self.character_names:
                ...
                for view in self.view_angles:
                    ...
                    view_data.append(data[1])                       # 2D Motion
