...
#     head_radius = int(torso_length/4.5)
    ...
    joints_radius = 7
    head_radius = int(joints_radius*1.5)
...
def motion2video_array(motion, h, w, colors, bg_color=(255, 255, 255), transparency=False, motion_tgt=None, show_progress=True, workers=6):
